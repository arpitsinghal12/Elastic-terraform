...
resource "null_resource" "elasticsearch" {
	triggers = {
		template = data.template_file.elasticsearch.rendered		
		}

	provisioner "local-exec"{
		command = "echo '${data.template_file.elasticsearch.rendered}' > elastic-ansible/roles/elastic-search/files/elasticsearch.yml"
		}
}
